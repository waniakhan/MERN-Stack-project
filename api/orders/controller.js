...
const sendDeliveryNotification = async (req, res) => {
    ...
    try {
        ...
        const mailGenEmail = {
            body: {
                name: order.customerName, // Use the customer's name from the order
                ...
                outro: 'Thank you for choosing ZM Store!'
            }
        };
...
module.exports = { demoMail, addOrders, allOrders, orderbyId, removeProductByOrderId, sendDeliveryNotification };
